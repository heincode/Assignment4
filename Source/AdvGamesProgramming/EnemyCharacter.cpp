...
void AEnemyCharacter::Tick(float DeltaTime)
{
	...
	{
		AgentPatrol();
		if ((bCanSeeActor && HealthComponent->HealthPercentageRemaining() >= 40.0f) || Type == EEnemyType::BOSS)
		{
...
EEnemyType AEnemyCharacter::GetStats()
{
	return Type;
}
...
void AEnemyCharacter::SetStats()
{
	...
	{
		Type = EEnemyType::ELITE;
		HealthComponent->MaxHealth = 150;
